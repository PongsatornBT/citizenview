...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2024 at 04:07 PM
...
CREATE TABLE `approve_user` (
  ...
  `user_agency` varchar(100) NOT NULL,
  `user_add_id` int(10) NOT NULL
...
INSERT INTO `approve_user` (`user_id`, `user_username`, `user_password`, `user_name`, `user_email`, `user_tel`, `user_agency`, `user_add_id`) VALUES
(7, 'test', 'cfb3e376701e118267ff53027c8b96b7', 'Pongsatorn Boontham', 'test@gmail.com', '0906578707', 'test', 30),
(23, 'paepongsatorn1sss', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn Boontham', 'sunshine999yd@gmail.com', '0906578707', 'test', 30),
(25, 'paepongsatorn1s', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorntest Boonthamtest', 'paepongsatorn1@asd', '0906578707', 'test2', 1),
(26, 'paepongsatorn1x', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn Boontham', 'paepongsatorn1x@asd', '0906578707', 'test', 30),
(28, 'paepongsatorn12xx', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'adadasfdfbrfsrf Boontham', 'paepongsatorn1@xxxx', '0906578707', 'test', 30),
(29, 'paepongsatorn1asdaw', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'aaaaaaaaaaaaaa aaaaaaaaaaaa', 'paepongsatorn1@asdasdzxcaw', '0906578707', 'test', 30),
(30, 'paepongsatorn1', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn Boontham', '63160094@go.buu.ac.th', '0906578707', 'บูรพา', 0),
(37, 'paepongsatorn2', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn Boontham', 'paepongsatorn@gmail.com', '0906578707', 'บูรพา', 30),
(39, 'test123123', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'test test', 'test@asdwad', '0906578707', 'test', 30),
(40, 'test12345', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn Boontham', 'paepongsatorn1@test', '0906578707', 'test', 30),
(41, 'paepongsatorn1aasd', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn Boontham', 'test12345@aawdwa', '0906578707', 'test', 40);
...
--
-- Table structure for table `watch_file_image`
--

CREATE TABLE `watch_file_image` (
  `file_image_id` int(11) NOT NULL,
  `file_image_name` varchar(500) CHARACTER SET utf8 NOT NULL,
  `watch_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `watch_file_image`
--

INSERT INTO `watch_file_image` (`file_image_id`, `file_image_name`, `watch_id`) VALUES
(7027, 'Khao-kiew-open-zoo-cover-1200.jpg', 3190);

-- --------------------------------------------------------

--
-- Table structure for table `watch_file_video`
--

CREATE TABLE `watch_file_video` (
  `file_video_id` int(11) NOT NULL,
  `file_video_name` varchar(500) CHARACTER SET utf8 NOT NULL,
  `watch_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `watch_file_video`
--
-- --------------------------------------------------------
...
CREATE TABLE `watch_log` (
  ...
  `watch_email` text NOT NULL,
  `watch_message` text NOT NULL,
  `watch_lat` text NOT NULL,
  `watch_lon` text NOT NULL,
  `watch_time` text NOT NULL,
  `watch_rating` float NOT NULL,
  `watch_location` text NOT NULL,
  `watch_province` text NOT NULL,
  `user_id` int(10) NOT NULL,
  `watch_status` varchar(20) DEFAULT NULL
...
INSERT INTO `watch_log` (`watch_id`, `watch_title`, `watch_name`, `watch_email`, `watch_message`, `watch_lat`, `watch_lon`, `watch_time`, `watch_rating`, `watch_location`, `watch_province`, `user_id`, `watch_status`) VALUES
(3190, 'เขาเขียว', 'พงศธร', '', 'เป็นแหล่งท่องเที่ยวที่นิยมในจังหวัดชลบุรี', '13.214808', '101.0544261', '2024-03-05 10:04:53pm', 4, 'หมู่ที่ 7 235 ตำบล บางพระ อำเภอศรีราชา ชลบุรี 20110', 'ชลบุรี', 0, 'รออนุมัติ');

-- --------------------------------------------------------

--
-- Table structure for table `watch_user`
--
...
CREATE TABLE `watch_user` (
  ...
  `user_gender` varchar(15) CHARACTER SET utf8 NOT NULL,
  `user_birthday` varchar(50) CHARACTER SET utf8 NOT NULL,
  `user_income` varchar(50) CHARACTER SET utf8 NOT NULL,
  `provinces_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `amphures_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `districts_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `user_zipcode` varchar(6) CHARACTER SET utf8 NOT NULL,
  `user_address` varchar(5000) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `watch_user`
--

INSERT INTO `watch_user` (`user_id`, `user_username`, `user_password`, `user_firstname`, `user_lastname`, `user_email`, `user_gender`, `user_birthday`, `user_income`, `provinces_id`, `amphures_id`, `districts_id`, `user_zipcode`, `user_address`) VALUES
(0, 'guest', 'guest', '', '', '', 'ไม่ระบุ', '', 'ไม่ระบุ', '0', '0', '0', '', ''),
(40, 'Super_adminasd', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn', 'Boontham', 'asd@asdxzcca', 'หญิง', '02-19-2006', '30000-50000', '0', '0', '0', '', ''),
(44, 'paepongsatorn1', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn', 'Boontham', 'sunshine999yd@gmail.com', 'ชาย', '05-19-2007', '50000+', '0', '0', '0', '', '99/48 หมู่บ้านเบญญาภา'),
(45, 'paepongsatorn2', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'asdasd', 'asdasdas', '2@asd', 'ไม่ระบุ', '04-17-2007', '10000-30000', '0', '0', '0', '', 'qwe'),
(65, 'Pongsatornasd', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn', 'Boontham', 'sunsxswhine999yd@gmail.com', 'หญิง', '03-26-2007', '30000-50000', '15', '183', '240605', '24120', '99/48 หมู่บ้านเบญญาภา'),
(66, 'paepongsatorn1xx', 'd5c9c52d049ac4742a3a31ad081ac4fb', 'Pongsatorn', 'paepos', 'sunshinexaw999yd@gmail.com', 'หญิง', '03-17-2007', '10000-30000', '16', '190', '250214', '25110', '99/48 หมู่บ้านเบญญาภา');
...
--
-- Indexes for table `watch_file_image`
--
ALTER TABLE `watch_file_image`
  ADD PRIMARY KEY (`file_image_id`);

--
-- Indexes for table `watch_file_video`
--
ALTER TABLE `watch_file_video`
  ADD PRIMARY KEY (`file_video_id`);
...
--
-- Indexes for table `watch_user`
--
ALTER TABLE `watch_user`
  ADD PRIMARY KEY (`user_id`);
...
--
-- AUTO_INCREMENT for table `watch_file_image`
--
ALTER TABLE `watch_file_image`
  MODIFY `file_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7028;

--
-- AUTO_INCREMENT for table `watch_file_video`
--
ALTER TABLE `watch_file_video`
  MODIFY `file_video_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `watch_log`
--
ALTER TABLE `watch_log`
  MODIFY `watch_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3191;

--
-- AUTO_INCREMENT for table `watch_user`
--
ALTER TABLE `watch_user`
